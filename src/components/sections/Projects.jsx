            ...
            <RevealOnScroll>
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition_all">
                        ...
                        hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition_all"
                                    >
                                        {tech}
                                    </span>
                                ))}
                        ...
                        hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition_all">
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                                {["Socket_IO", "Express", "React"].map((tech, key) => (
                                    <span
                                        key={key}
                                        className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm
                        hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition_all"
